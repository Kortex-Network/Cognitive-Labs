...
1. **Navigate to GitHub**: Go to the forked repository
   - URL: https://github.com/olaleyeolajide81-sketch/Decentralized-Identity-LABS-

2. **Switch to the Correct Branch**:
   - Click the branch dropdown
   - Select `Implement-Gas-Optimization-for-LABS-Registry`

3. **Create Pull Request**:
   - Click the "Contribute" button
   - Click "Open pull request"
   - Ensure base branch is `main`
   - Ensure compare branch is `Implement-Gas-Optimization-for-LABS-Registry`

4. **Fill PR Details**:
   - **Title**: `feat: Implement Gas Optimization for Cognitive Lab Registry - Issue #138`
...
gh pr create \
  ...
  --base main \
  --head Implement-Gas-Optimization-for-LABS-Registry
```
...
curl -X POST \
  ...
  https://api.github.com/repos/olaleyeolajide81-sketch/Decentralized-Identity-LABS-/pulls \
  -d '{
    "title": "feat: Implement Gas Optimization for Cognitive Lab Registry - Issue #138",
    "body": "'"$(cat PR_DESCRIPTION.md)"'",
    "head": "Implement-Gas-Optimization-for-LABS-Registry",
...
✅ **Branch Created**: `Implement-Gas-Optimization-for-LABS-Registry`
...
- **Forked Repository**: https://github.com/olaleyeolajide81-sketch/Decentralized-Identity-LABS-/
- **Branch**: https://github.com/olaleyeolajide81-sketch/Decentralized-Identity-LABS-/tree/Implement-Gas-Optimization-for-LABS-Registry
