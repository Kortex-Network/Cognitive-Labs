...
/**
 * @title EnhancedLABSGovernanceToken
 ...
 */
contract EnhancedLABSGovernanceToken is ERC20, ERC20Votes, Ownable, ReentrancyGuard {
    ...
    constructor() ERC20("LABS Governance Token", "LABSGT") ERC20Permit("LABS Governance Token") {
