...
/**
 * @title LABSGovernanceToken
 * @dev ERC20 token with voting capabilities for LABS governance
 * Used for voting on contract upgrades and protocol changes
 */
contract LABSGovernanceToken is ERC20, ERC20Votes, Ownable {
    ...
    constructor() ERC20("LABS Governance Token", "LABSGT") {
