...
class CredentialService {
  ...
  getMockCredentials() {
    ...
    const issuers = [
      'LABS:stellar:GABC123DEF456GHI789JKL012MNO345PQR678STU901VWX234YZ',
      'LABS:stellar:GDEF789GHI012JKL345MNO678PQR901STU234VWX567YZA890BCD123',
      'LABS:stellar:GHI234JKL567MNO890PQR123STU456VWX789YZA012BCD345EFG678'
    ];
    const subjects = [
      'LABS:stellar:GJKL012MNO345PQR678STU901VWX234YZA567BCD890EFG123HI456',
      'LABS:stellar:GMNO678PQR901STU234VWX567YZA890BCD123EFG456HI789JKL012',
      'LABS:stellar:GPQR234STU567VWX890YZA123BCD456EFG789HI012JKL345MNO678'
    ];
